...
$(LIBDIR)/cover.dll : $(LIBDIR)/cover_la-cover.o $(LIBDIR)/cpu_asm_la-cpu_asm.o $(LIBDIR)/deinterlace_asm_la-deinterlace_asm.o \
...
$(LIBDIR)/cover_la-cover.o : cover.c cover.h cover_base.h
	i686-w64-mingw32-gcc -std=gnu99 -DHAVE_CONFIG_H -I. -I../vlc-2.2.0-rc2/include -I../vlc-2.2.0-rc2 \
