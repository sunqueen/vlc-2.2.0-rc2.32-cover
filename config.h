...
#define CONFIGURE_LINE "./configure  '--host=i686-pc-mingw32' '--enable-lua' '--enable-faad' '--enable-flac' '--enable-theora' '--enable-twolame' '--enable-quicktime' '--enable-avcodec' '--enable-merge-ffmpeg' '--enable-dca' '--enable-mpc' '--enable-libass' '--enable-x264' '--enable-schroedinger' '--enable-realrtsp' '--enable-live555' '--enable-dvdread' '--enable-shout' '--enable-goom' '--enable-caca' '--disable-sdl' '--enable-qt' '--enable-skins2' '--enable-sse' '--enable-mmx' '--enable-libcddb' '--enable-zvbi' '--disable-telx' '--enable-nls' '--disable-taglib' '--disable-mkv' '--disable-sftp' '--disable-x265' 'host_alias=i686-pc-mingw32' 'CC=i686-w64-mingw32-gcc' 'LDFLAGS=-L/usr/win32/lib' 'CPPFLAGS=-I/usr/win32/include -I/usr/win32/include/ebml' 'CXX=i686-w64-mingw32-g++' 'PKG_CONFIG_LIBDIR=/usr/win32/lib/pkgconfig'"
...
#define PACKAGE_STRING "vlc 2.2.0-rc2"
...
#define PACKAGE_VERSION "2.2.0-rc2"

/* version development string */
#define PACKAGE_VERSION_DEV "rc2"
...
#define VERSION_MESSAGE "2.2.0-rc2 Weatherwax"
